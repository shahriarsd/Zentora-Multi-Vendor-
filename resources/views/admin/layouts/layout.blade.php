...
<body>
	<div class="wrapper">
		<nav id="sidebar" class="sidebar js-sidebar">
         ...
         <i class="align-middle" data-feather="  shopping-cart"></i> <span class="align-middle">History</span>
            </a>
					</li>
    	...
    	<li class="sidebar-item {{ request()->routeIs('admin.settings')? 'active': '' }}">
              ...
              <i class="align-middle" data-feather="list"></i> <span class="align-middle">Setting</span>
            </a>
					</li>
